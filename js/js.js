...
function makeMarkupForLazyImages(imagesArray) {
  const markup = imagesArray.map(item => {
    ...
    <li class="feed_item">
      ...
      >
      <p>
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora recusandae autem asperiores laudantium sed adipisci aut reprehenderit, quaerat atque quidem?
      </p>
    </li>
    `
  }).join('');
